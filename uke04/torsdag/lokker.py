...
# for each løkke
def for_each_lokke():
    mengde = {"Ski", "Løping", "Gåing", "Dansing", "Utfor"}

    for element in mengde:
        print(f"Elementet i listen er nå: {element}")
    

# logiske feil i while-loops
def logisk_feil():
    i = 0
    while i > 10:
        print(f"Telleren er nå {i}")
#Forsøk å finne feilen uten å kjøre koden
