...
# A) Hva skiller prosedyrer med parametre fra funksjoner med parametre? 
# B) Kan det fortsatt være en funksjon hvis den ikke har parametre?
# C) Begrunn svaret i b). Hvorfor eller hvorfor ikke? Tenk tilbake på forelesningen og hva som skiller prosedyrer fra funksjoner.
#
#
# Oppgave 3
