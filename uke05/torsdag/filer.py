...
#
# Oppgave 6
# Lag et program som skriver historiske personers navn og fødselsår til fil. Navnene og fødselsårene skal være lagret i en ordbok, med navn som nøkler og fødselsår som verdier.
# Tips: husk å åpne og lukke filen ved behov.
#
# Opprett en ordbok med fem historiske personer og deres fødselsår.
#
# Skriv navn og fødselsår til fil. Hver linje skal ha en historisk persons navn og fødselsår, atskilt med ; (semikolon). Filen skal hete “historiske_personer_fodt.txt”. 
#
# Lag et nytt program, som bruker en funksjon til å lese inn filen du laget i b) og som returnerer en ordbok tilsvarende den i a). Funksjonen skal ha parameter filnavn. 
